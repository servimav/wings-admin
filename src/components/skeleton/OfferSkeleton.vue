...
<template>
  ...
  >
    <div class="mb-4 flex items-center justify-center rounded bg-gray-300 dark:bg-gray-700">
      <svg
    ...
    <div class="mb-2 h-2 w-full rounded-full bg-gray-200 dark:bg-gray-700"></div>
