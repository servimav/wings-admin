...
<template>
	<div>
		...
		<label :for="id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an option</label>
		<select :id="id" @change="onChange" :value="modelValue" :name="id"
