...
<template>
	<div class="p-2" v-if="storeId && offer">
		...
		<template v-if="showOfferForm">
			<OfferForm :store-id="storeId" :update="offer" @updated="onOfferUpdated"
		...
		<div v-else class="p-2">
			...
			<div class="flex flex-wrap justify-end">
				...
				<button class="btn-negative py-1" :data-modal-target="deleteModalId" :data-modal-toggle="deleteModalId">
					Eliminar
				</button>
			</div>
			<!-- / Actions -->
			...
			<div class="p-4 rounded-md bg-slate-100 mt-2 relative">
				...
				<div class="absolute bottom-1 right-1 z-10">
					<div class="rounded-full shadow-sm border p-2 text-sm" :class="offer.available
			...
			<div class="p-2 rounded-md border mt-4 shadow-sm" v-if="offer.categories && offer.categories.length">
			...
			<div class="p-2 rounded-md border mt-2 shadow-sm" v-if="offer.attributes && offer.attributes.length">
